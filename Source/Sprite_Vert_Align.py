...
#     if i < 10 :
#         image_paths.append("Assets\\Characters\\Pi\\Main_PI_Rotation\\PI_0" + str(i) + ".png")
#     else :
#         image_paths.append("Assets\\Characters\\Pi\\Main_PI_Rotation\\PI_" + str(i) + ".png")
...
# Save the new image
new_image.save("Digitalized_PI_Rotation(538 x 464).png")